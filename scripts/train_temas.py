#!/usr/bin/env python3
"""Fine-tune mmBERT-small for tema classification (10 classes)."""
import argparse
import json
import sys
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train tema classifier.")
    parser.add_argument("--splits-dir", type=Path, default=Path("data/splits"))
    parser.add_argument("--output-dir", type=Path, default=Path("models/temas"))
